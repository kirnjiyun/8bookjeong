...
|                           메인페이지 스크롤                            |                      메인페이지 검색                      |
| :--------------------------------------------------------------------: | :-------------------------------------------------------: |
| <img src="src/assets/images/readme/메인페이지 스크롤.gif" width="300"> | <img src="src/assets/images/readme/검색.gif" width="300"> |

|                       책 상세페이지                       |                            카테고리                            |
| :-------------------------------------------------------: | :------------------------------------------------------------: |
| <img src="src/assets/images/readme/상세.gif" width="300"> | <img src="src/assets/images/readme/카테고리 .gif" width="300"> |
